...
<div class="intro-hero">
  ...
  <div class="line-garden" aria-label="Line art about music, movement, coffee, food, walking, and the sea">
    <svg viewBox="0 0 900 270" role="img">
      <title>Continuous line illustration of music, yoga, coffee, food, walking, and the sea</title>
      <g class="line-drawing guide">
        <path d="M2 180 C70 208 106 136 170 154 S278 178 352 122 S432 30 474 58" />
        <path d="M176 102 C236 120 264 70 316 91 S396 126 455 114 S540 88 588 124" />
        <path d="M292 205 C378 184 452 216 540 196 S680 168 782 198 S862 205 898 176" />
        <path d="M636 80 C676 48 725 64 746 96 S780 136 836 112" />
      </g>
      <g class="line-drawing">
        <path d="M22 116 C22 64 55 42 92 43 C130 44 158 68 158 118" />
        <path d="M27 108 C4 114 5 154 30 160 C45 154 47 113 27 108 Z" />
        <path d="M152 108 C176 114 176 154 151 160 C135 154 134 113 152 108 Z" />
        <path d="M36 82 C55 58 121 59 145 84" />
        <path d="M90 160 C96 179 86 197 61 207" />
        <path d="M174 42 C170 62 170 62 170 83" />
        <path d="M170 48 C189 54 193 66 174 75" />
        <path d="M222 55 C218 80 218 80 218 99" />
        <path d="M218 62 C238 68 241 82 222 91" />
      </g>
      <g class="line-drawing accent">
        <path d="M146 182 C143 154 190 153 193 181 C189 205 151 205 146 182 Z" />
        <path d="M146 190 C158 202 182 202 194 189" />
        <path d="M194 172 C220 168 228 192 204 204" />
        <path d="M159 144 C143 132 170 118 154 104" />
        <path d="M177 144 C162 132 188 118 172 104" />
      </g>
      <g class="line-drawing">
        <path d="M320 78 C334 82 340 96 333 110 C325 124 306 123 299 110 C293 96 302 81 320 78 Z" />
        <path d="M311 113 C318 132 329 148 348 162" />
        <path d="M316 116 C308 91 301 63 300 34" />
        <path d="M300 34 C298 24 304 17 312 12" />
        <path d="M323 123 C342 136 365 146 389 153" />
        <path d="M348 162 C316 176 282 188 246 192" />
        <path d="M246 192 C263 194 278 200 292 210" />
        <path d="M350 163 C374 185 410 193 450 188" />
        <path d="M246 207 C306 207 376 207 458 207" />
      </g>
      <g class="line-drawing">
        <path d="M492 172 C499 142 556 141 566 172 C554 196 504 197 492 172 Z" />
        <path d="M501 160 C520 174 542 174 561 160" />
        <path d="M496 176 C516 190 544 190 565 176" />
        <path d="M510 151 C519 144 531 145 539 151" />
        <path d="M520 141 C525 135 535 136 540 142" />
        <path d="M534 140 C541 133 552 135 557 144" />
        <path d="M516 127 L553 91" />
        <path d="M538 130 L576 98" />
      </g>
      <g class="line-drawing">
        <path d="M674 58 C658 61 649 76 653 92 C657 108 676 115 690 105 C704 94 700 66 680 61" />
        <path d="M662 61 C656 53 664 46 674 49" />
        <path d="M685 62 C697 58 705 64 701 75" />
        <path d="M664 111 C656 136 653 158 663 181" />
        <path d="M687 113 C699 135 704 157 699 181" />
        <path d="M666 116 C650 130 636 147 628 169" />
        <path d="M689 117 C711 127 732 142 748 162" />
        <path d="M664 181 C648 199 628 211 605 216" />
        <path d="M699 181 C718 198 741 208 766 212" />
        <path d="M688 112 C704 112 719 119 732 131" />
        <path d="M674 117 C682 135 684 154 678 174" />
        <path d="M692 124 L716 132 L713 153" />
      </g>
      <g class="line-drawing primary">
        <path d="M766 128 C804 125 844 128 888 126" />
        <path d="M762 148 C802 164 846 165 890 148" />
        <path d="M758 171 C802 188 846 188 892 170" />
        <path d="M792 110 C811 80 852 80 870 109" />
        <path d="M816 34 C826 25 838 25 848 34" />
        <path d="M856 62 C868 52 883 52 894 63" />
      </g>
    </svg>
  </div>
</div>
...
<div class="feature-list">
  <section id="about" class="feature-row">
  ...
  <section id="interests" class="feature-row compact-row">
    ...
    <svg class="row-line" viewBox="0 0 200 40" aria-hidden="true">
      <path d="M4 24 C30 5 44 36 70 18 S110 4 132 25 S168 37 196 10" />
    </svg>
  </section>

  <section id="work" class="feature-row work-row">
    <div class="feature-icon" aria-hidden="true">
